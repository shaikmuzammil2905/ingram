        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-brand-purple-tint text-brand-purple text-sm font-bold px-7 py-3 rounded-lg shadow-md transition-all duration-200 group"
            >
